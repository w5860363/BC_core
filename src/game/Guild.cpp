...
void Guild::CreateDefaultGuildRanks(int locale_idx)
{
    ...
    CreateRank(objmgr.GetBlizzLikeString(LANG_GUILD_MASTER, locale_idx),   GR_RIGHT_ALL);
    CreateRank(objmgr.GetBlizzLikeString(LANG_GUILD_OFFICER, locale_idx),  GR_RIGHT_ALL);
    CreateRank(objmgr.GetBlizzLikeString(LANG_GUILD_VETERAN, locale_idx),  GR_RIGHT_GCHATLISTEN | GR_RIGHT_GCHATSPEAK);
    CreateRank(objmgr.GetBlizzLikeString(LANG_GUILD_MEMBER, locale_idx),   GR_RIGHT_GCHATLISTEN | GR_RIGHT_GCHATSPEAK);
    CreateRank(objmgr.GetBlizzLikeString(LANG_GUILD_INITIATE, locale_idx), GR_RIGHT_GCHATLISTEN | GR_RIGHT_GCHATSPEAK);
}
