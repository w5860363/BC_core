...
#ifndef BLIZZLIKE_SHAREDDEFINES_H
#define BLIZZLIKE_SHAREDDEFINES_H
...
enum SpellAttributesEx2
{
    ...
    SPELL_ATTR_EX2_TRIGGERED_CAN_TRIGGER      = 0x00400000,       // 22 spell can trigger even if triggered
    ...
    SPELL_ATTR_EX2_TRIGGERED_CAN_TRIGGER_2    = 0x40000000,       // 30 spell can trigger even if triggered
