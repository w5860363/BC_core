...
#ifndef BLIZZLIKE_GAMEEVENT_MGR_H
#define BLIZZLIKE_GAMEEVENT_MGR_H
...
class GameEventMgr
{
    public:
        ...
        void HandleQuestgiverCompleteQuest(uint32 quest_id);  // called on world event type quest completions
