...
#ifndef BLIZZLIKE_CREATURE_EAI_H
#define BLIZZLIKE_CREATURE_EAI_H
...
enum EventAI_Type
{
    ...
    // BlizzLike only
    EVENT_T_RESET                   = 35,                   // Is it called after combat, when the creature respawn and spawn. -- BLIZLIKE ONLY
