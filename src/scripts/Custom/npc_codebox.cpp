...
#define D_ENTER_CODE "我有一个卡密..　"
#define D_CANCEL_CODE "关闭..　"
#define SAY_INV_FULL "你的卡密是正确的,但是你没有足够的背包空间,请检查背包..　"
#define SAY_EXPIRED "对不起你的卡密已经过期,请输入有效的卡密.　"
#define SAY_INVALID "对不起你的卡密是无效的,请输入有效的卡密.　"
#define SAY_GIVE_PRESENT "这是给你的,希望你会喜欢它.　"
#define SAY_EXTRA_BUFF "天拉!你幸运拉,你获得一个物品和一个BUFF.　"
#define SAY_GIVE_BUFF "这是一个特殊的BUFF,我只赠送给你.　"
#define SAY_GOODBYE "很高兴见到你,再见!　"
