        ...
        if (SpawnedAdds < 42)
        {
            ...
            if (AddSpawnTimer <= diff)
            {
                ...
                if (SpawnedAdds >= 42)
                {
                    ...
                    //Teleport self to a hiding spot (this causes errors in the blizzlike log but no real issues)
                    ...
                    else error_log("BSCR: Blackwing Lair: Unable to spawn nefarian properly.");
                }
